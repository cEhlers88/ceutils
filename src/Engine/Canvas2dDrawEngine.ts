...
import AbstractGeometryDrawer, {
  ERotateType,
  IGeometryArgs
} from "../canvas/GeometryBuilder/AbstractGeometryDrawer";
...
export default class Canvas2dDrawEngine implements IDrawEngine {
  ...
  public rectangle(
    ...
    pivot: number | number[] | IVector2D | IVector2D[] = 0.5
  ): IDrawEngine {
    // const body = [rect.x, rect.y, rect.width, rect.height];
  ...
  private _createAndDrawGeometry(
    type: string,
    geometryArgs: IGeometryArgs | any
  ): any {
