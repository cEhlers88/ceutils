import AbstractGeometryDrawer, { IGeometryArgs, IGeometryStore} from "./AbstractGeometryDrawer";
...
export default class RectangleGeometryDrawer extends AbstractGeometryDrawer {
    ...
    protected _update(currentStore: IGeometryStore, updateArgs: IRectangleGeometryArgs): IGeometryStore {
